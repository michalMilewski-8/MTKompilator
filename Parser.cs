...
// DateTime: 12.06.2020 11:54:52
// UserName: miles
// Input file <..\..\kompilator.y - 12.06.2020 11:54:50>
...
{ ((Compiler.CodeNode)ValueStack[ValueStack.Depth-2].node).idents = ValueStack[ValueStack.Depth-3].idents; CurrentSemanticValue.node = new Compiler.BlockNode(ValueStack[ValueStack.Depth-2].node); CurrentSemanticValue.node.linenumber = Compiler.lineno;}
        break;
