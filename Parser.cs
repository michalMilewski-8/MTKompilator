...
// DateTime: 12.06.2020 00:18:12
// UserName: miles
// Input file <..\..\kompilator.y - 12.06.2020 00:18:09>
...
#pragma warning restore 649
  ...
  static Parser() {
    states[0] = new State(new int[]{4,3,8,125,18,129},new int[]{-19,1});
    states[1] = new State(new int[]{3,2});
    states[2] = new State(-1);
    states[3] = new State(new int[]{8,4,2,123});
    states[4] = new State(new int[]{5,115,6,116,7,117,2,121,8,12,41,21,36,37,37,38,12,39,15,40,42,65,43,66,44,67,24,71,20,74,21,79,23,86,25,91,40,93,39,95,17,99,9,-9},new int[]{-21,5,-22,8,-23,103,-1,105,-12,122,-11,10,-2,16,-3,17,-9,24,-4,47,-5,54,-6,57,-7,60,-8,63,-13,35,-10,64});
    states[5] = new State(new int[]{9,6});
    states[6] = new State(new int[]{18,7});
    states[7] = new State(-2);
    states[8] = new State(new int[]{8,12,41,21,36,37,37,38,12,39,15,40,42,65,43,66,44,67,24,71,20,74,21,79,23,86,25,91,40,93,39,95,17,99,2,100,9,-7},new int[]{-12,9,-11,10,-2,16,-3,17,-9,24,-4,47,-5,54,-6,57,-7,60,-8,63,-13,35,-10,64});
    states[9] = new State(-6);
    states[10] = new State(new int[]{8,12,41,21,36,37,37,38,12,39,15,40,42,65,43,66,44,67,24,71,20,74,21,79,23,86,25,91,40,93,39,95,17,99,2,100,9,-22},new int[]{-12,11,-11,10,-2,16,-3,17,-9,24,-4,47,-5,54,-6,57,-7,60,-8,63,-13,35,-10,64});
    ...
    states[21] = new State(new int[]{10,22,28,-73,29,-73,13,-73,14,-73,11,-73,12,-73,30,-73,31,-73,32,-73,33,-73,34,-73,35,-73,27,-73,26,-73,17,-73,18,-73,16,-73});
    ...
    states[24] = new State(new int[]{27,69,26,70,17,-41,18,-41,16,-41},new int[]{-18,25});
    states[25] = new State(new int[]{36,37,37,38,12,39,15,40,41,68,42,65,43,66,44,67},new int[]{-4,26,-5,54,-6,57,-7,60,-8,63,-13,35,-10,64});
    states[26] = new State(new int[]{30,48,31,49,32,50,33,51,34,52,35,53,27,-42,26,-42,17,-42,18,-42,16,-42},new int[]{-17,27});
    states[27] = new State(new int[]{36,37,37,38,12,39,15,40,41,68,42,65,43,66,44,67},new int[]{-5,28,-6,57,-7,60,-8,63,-13,35,-10,64});
    states[28] = new State(new int[]{11,55,12,56,30,-44,31,-44,32,-44,33,-44,34,-44,35,-44,27,-44,26,-44,17,-44,18,-44,16,-44},new int[]{-16,29});
    states[29] = new State(new int[]{36,37,37,38,12,39,15,40,41,68,42,65,43,66,44,67},new int[]{-6,30,-7,60,-8,63,-13,35,-10,64});
    states[30] = new State(new int[]{13,58,14,59,11,-46,12,-46,30,-46,31,-46,32,-46,33,-46,34,-46,35,-46,27,-46,26,-46,17,-46,18,-46,16,-46},new int[]{-15,31});
    states[31] = new State(new int[]{36,37,37,38,12,39,15,40,41,68,42,65,43,66,44,67},new int[]{-7,32,-8,63,-13,35,-10,64});
    states[32] = new State(new int[]{28,61,29,62,13,-48,14,-48,11,-48,12,-48,30,-48,31,-48,32,-48,33,-48,34,-48,35,-48,27,-48,26,-48,17,-48,18,-48,16,-48},new int[]{-14,33});
    ...
    states[47] = new State(new int[]{30,48,31,49,32,50,33,51,34,52,35,53,27,-43,26,-43,17,-43,18,-43,16,-43},new int[]{-17,27});
    ...
    states[54] = new State(new int[]{11,55,12,56,30,-45,31,-45,32,-45,33,-45,34,-45,35,-45,27,-45,26,-45,17,-45,18,-45,16,-45},new int[]{-16,29});
    states[55] = new State(-62);
    states[56] = new State(-63);
    states[57] = new State(new int[]{13,58,14,59,11,-47,12,-47,30,-47,31,-47,32,-47,33,-47,34,-47,35,-47,27,-47,26,-47,17,-47,18,-47,16,-47},new int[]{-15,31});
    states[58] = new State(-64);
    states[59] = new State(-65);
    states[60] = new State(new int[]{28,61,29,62,13,-49,14,-49,11,-49,12,-49,30,-49,31,-49,32,-49,33,-49,34,-49,35,-49,27,-49,26,-49,17,-49,18,-49,16,-49},new int[]{-14,33});
    states[61] = new State(-66);
    states[62] = new State(-67);
    states[63] = new State(-51);
    states[64] = new State(-53);
    states[65] = new State(-74);
    states[66] = new State(-75);
    ...
    states[83] = new State(new int[]{22,84,8,-30,41,-30,36,-30,37,-30,12,-30,15,-30,42,-30,43,-30,44,-30,24,-30,20,-30,21,-30,23,-30,25,-30,40,-30,39,-30,17,-30,2,-30,9,-30});
    ...
    states[103] = new State(new int[]{5,115,6,116,7,117,2,118,8,-11,41,-11,36,-11,37,-11,12,-11,15,-11,42,-11,43,-11,44,-11,24,-11,20,-11,21,-11,23,-11,25,-11,40,-11,39,-11,17,-11,9,-11},new int[]{-22,104,-23,103,-1,105});
    states[104] = new State(-10);
    states[105] = new State(new int[]{2,113,41,-12},new int[]{-24,106});
    states[106] = new State(new int[]{41,107});
    states[107] = new State(new int[]{38,110,17,-17,18,-17},new int[]{-25,108});
    states[108] = new State(new int[]{17,19,18,20},new int[]{-26,109});
    states[109] = new State(-13);
    states[110] = new State(new int[]{41,111});
    states[111] = new State(new int[]{38,110,17,-17,18,-17},new int[]{-25,112});
    ...
    states[125] = new State(new int[]{5,115,6,116,7,117,2,121,8,12,41,21,36,37,37,38,12,39,15,40,42,65,43,66,44,67,24,71,20,74,21,79,23,86,25,91,40,93,39,95,17,99,9,-9},new int[]{-21,126,-22,8,-23,103,-1,105,-12,122,-11,10,-2,16,-3,17,-9,24,-4,47,-5,54,-6,57,-7,60,-8,63,-13,35,-10,64});
    states[126] = new State(new int[]{9,127});
    states[127] = new State(new int[]{18,128});
    states[128] = new State(-4);
    states[129] = new State(-5);
    ...
    rules[4] = new Rule(-19, new int[]{8,-21,9,18});
    rules[5] = new Rule(-19, new int[]{18});
    rules[6] = new Rule(-21, new int[]{-22,-12});
    rules[7] = new Rule(-21, new int[]{-22});
    rules[8] = new Rule(-21, new int[]{-12});
    rules[9] = new Rule(-21, new int[]{});
    rules[10] = new Rule(-22, new int[]{-23,-22});
    rules[11] = new Rule(-22, new int[]{-23});
    rules[12] = new Rule(-24, new int[]{});
    rules[13] = new Rule(-23, new int[]{-1,-24,41,-25,-26});
    rules[14] = new Rule(-23, new int[]{2,41,-26});
    rules[15] = new Rule(-23, new int[]{-1,2,-26});
    rules[16] = new Rule(-25, new int[]{38,41,-25});
